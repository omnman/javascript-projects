...
// Something weird is happening below, the inputs are not registering Line 39-53
if (astronautCount > 7){
    console.log("too many astronaut")
} else if (astronautStatus = !"ready") {
    console.log("Astronauts not ready")
} else if (totalMassKg > maximumMassLimit) {
    console.log("Total mass is over limit")
} else if (fuelTempCelsius < -300 || fuelTempCelsius > -150){
    console.log("Fuel Temp out of range")
